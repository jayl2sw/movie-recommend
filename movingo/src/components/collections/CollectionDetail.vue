    ...
    <div class="row my-4">
      ...
      <div class="col-6">
        ...
        <div id="buttons">
          <div>
            <div v-if="liked">
              <button @click="likeCollection(collection.pk)"><i class="ilike bi bi-suit-heart-fill"></i></button>
              <span class="mx-2">{{ like_cnt }}</span>
            </div>
            <div v-if="!liked">
              <button @click="likeCollection(collection.pk)"><i class="ilike bi bi-suit-heart"></i></button>
              <span class="mx-2">{{ like_cnt }}</span>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...mapActions(['fetchCollection', 'likeCollection'])
